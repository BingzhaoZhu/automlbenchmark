...
python runbenchmark.py FastFTT_AG_hog_ft0 ag_finetune mytest1h -m aws -p 520
python runbenchmark.py FastFTT_AG_hog_ft250 ag_finetune mytest1h -m aws -p 520
python runbenchmark.py FastFTT_AG_hog_ft500 ag_finetune mytest1h -m aws -p 520
