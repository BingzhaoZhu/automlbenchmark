...
python runbenchmark.py FTT_AG ag mytest -m aws -p 40 -f 0
python runbenchmark.py FTT_AG_pretrain_identical ag mytest -m aws -p 40 -f 0
python runbenchmark.py FTT_AG_pretrain_randperm_03 ag mytest -m aws -p 40 -f 0
python runbenchmark.py FTT_AG_pretrain_randperm_06 ag mytest -m aws -p 40 -f 0
python runbenchmark.py FTT_AG_pretrain_randperm_09 ag mytest -m aws -p 40 -f 0
python runbenchmark.py FTT_AG_pretrain_randblk_03 ag mytest -m aws -p 40 -f 0
python runbenchmark.py FTT_AG_pretrain_randblk_06 ag mytest -m aws -p 40 -f 0
python runbenchmark.py FTT_AG_pretrain_randblk_09 ag mytest -m aws -p 40 -f 0
