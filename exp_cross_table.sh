...
python runbenchmark.py FTT_AG_hog_ft0_lowe ag_finetune mytest1h -m aws -p 520
python runbenchmark.py FTT_AG_hog_ft250_lowe ag_finetune mytest1h -m aws -p 520
python runbenchmark.py FTT_AG_hog_ft500_lowe ag_finetune mytest1h -m aws -p 520
python runbenchmark.py FTT_AG_hog_ft750_lowe ag_finetune mytest1h -m aws -p 520
python runbenchmark.py FTT_AG_hog_ft1000_lowe ag_finetune mytest1h -m aws -p 520
